...
if __name__ == '__main__':
    ...
    for i in range(bboxes.shape[0]):
        ...
        image = cv2ImgAddText(image, labels[0], (x1, y1 - 12), textColor=(255, 255, 0), textSize=text_size)
    ...
    # resize for imshow
    image = cv2.resize(image, (0, 0), fx=imshow_resize, fy=imshow_resize, interpolation=cv2.INTER_CUBIC)
